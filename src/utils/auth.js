...
const authDomain = 'ilanaboeira.au.auth0.com'
const clientId = 'tDtFIPWTqNS5r3LBZBj4vmtm8xN5s9Jd'
...
class AuthService {
  ...
  isCurrent = () => {
    ...
    let now = new Date()
    let exp = new Date(parseInt(expString, 10)) // 10 is the radix parameter
    if ( exp < now ) {
      this.logout()
      return false
    } else {
